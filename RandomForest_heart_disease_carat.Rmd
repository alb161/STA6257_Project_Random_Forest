...
datacholesteroral=data1
data_bp_hr=data1
dataage=data1
dataother=data1

#boxplot serum cholesterol, resting blood pressure, and max heart rate
datacholesteroral = datacholesteroral %>% select(1,4,5,8)
boxplot(x=NULL, data=datacholesteroral, width=8, height=8)

# boxplot age
dataage = dataage %>% select('age')
boxplot(dataage)

# boxplot of all other variables
dataother = dataother %>% select(2,3,6,7,9:14)
boxplot(dataother)
...
datacholesteroral = data1$serum.cholestoral

#rerun boxplot
boxplot(datacholesteroral)
```

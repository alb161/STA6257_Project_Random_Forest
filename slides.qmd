...
## Visualization Boxplot #1 {style="font-size: 80%;"}
...
## Visualization Boxplot #2 {style="font-size: 80%;"}
...
-  Bootstrap randomly selects n number of observations
with replacement

-  K-Fold Cross-validation creates subsets of the data
then randomly shuffles the observations into the subset "folds"

- K-Fold trial was more accurate 0.8472 vs 0.8330

##  K-Fold Cross-Validation: Tuning the Model {style="font-size: 50%;"}

<b>Selecting the best possible number of features first</b>
